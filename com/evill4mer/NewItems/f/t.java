  ...
  implements p
{
  ...
  public void a(Player paramPlayer, Location paramLocation, boolean paramBoolean)
  {
    ...
    new u(this, localLocation, (PacketPlayOutPlayerInfo)localObject).runTaskLater(a, 50L);
  ...
  public void w()
  {
    d = Bukkit.getScheduler().scheduleSyncRepeatingTask(a, new v(this), 0L, 20L);
  }
}

  ...
  implements p
{
  ...
  public void a(Player paramPlayer, Location paramLocation, boolean paramBoolean)
  {
    ...
    new x(this, localLocation, (PacketPlayOutPlayerInfo)localObject).runTaskLater(a, 50L);
  ...
  public void w()
  {
    d = Bukkit.getScheduler().scheduleSyncRepeatingTask(a, new y(this), 0L, 20L);
  }
}
